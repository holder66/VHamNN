...
All Attributes
 Index  Name                          Count  Uniques  Missing      %  Type
     ...
     6  visit_concept_name             1365       30        0    0.0     D
...
C              40
Total:        132
Discrete Attributes for Training (89 attributes)
 Index  Name                        Uniques
     3  age.splits                        3
     5  visit_start_datetime              3
     6  visit_concept_name               30
     7  is_icu                            3
     8  was_ventilated                    2
...
Continuous Attributes for Training (40 attributes)
 Index  Name                               Min         Max
...
discharged             1183
deceased                182
processing time: 0 hrs 0 min  0.187 sec
➜  vhamnn git:(master) ✗ 
```
...
Bin range for continuous attributes: from 2 to 16 with interval 1
 Index  Name                         Type   Rank Value   Bins
   ...
   118  3094-0_Urea nitrogen [Mass/volume] in Serum or Plasma  C           29.21      6
    ...
    17  dm_v                         D           27.68      0
     6  visit_concept_name           D           27.56      0
...
processing time: 0 hrs 0 min  0.196 sec
```
